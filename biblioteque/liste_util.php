                ...
                <div class="inner">
                    ...
                    <nav>
                        <ul class="sf-menu">
                            ...
                            <li class="current"><a href="liste_util.php">Liste Utilisateur</a></li>
                                        ...
                                        <article class="indent-bot">
                                            ...
                                            <div class="wrapper hr-border-1">
                                                ...
                                                foreach ($liste_util as $util) {
                                                    ...
                                                    echo '<dl class = "def-list-1">';
                                                    echo '<dt>';
                                                    echo '<a href="supprimer_util.php?id='.$util['id'].'"><input type="button" value="Supprimer"></a>';
                                                    echo '</dt>';
                                                    echo '</dl>';
                                                    echo '<dl class = "def-list-1">';
                                                    echo '<dt>';
