                                        ...
                                        <article class="indent-bot">
                                            <div class="wrapper hr-border-1">
                                                <div class="grid_4 alpha">
                                                    <form method="post" action="modifier_admin_action.php">
                                                        ...
                                                        <dl class="def-list-1">
                                                            ...
                                                            <dd>
                                                                <input type="text" name="login" value="<?php echo $obj->getnom(); ?>">
                                                            </dd>
                                                        </dl>
                                                        <dl class="def-list-1">
                                                            <dt>
                                                            ...
                                                            <dd>
                                                                <input type="text" name="mdp" value="<?php echo $obj->getMdp(); ?>">
                                                            </dd>
                                                        </dl>
                                                        <dl class="def-list-1">
                                                            <dt>
