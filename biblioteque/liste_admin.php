                ...
                <div class="inner">
                    ...
                    <nav>
                        <ul class="sf-menu">
                            ...
                            <li class="current"><a href="liste_admin.php">Liste Admin</a></li>
                                        ...
                                        <article class="indent-bot">
                                            ...
                                            <div class="wrapper hr-border-1">
                                                ...
                                                foreach ($liste_admin as $admin) {
                                                    ...
                                                    echo '<dl class = "def-list-1">';
                                                    echo '<dt>';
                                                    echo '<a href="modifier_admin.php?id='.$admin['id'].'"><input type="button" value="Modifier"></a>';
                                                    echo '</dt>';
                                                    echo '</dl>';
                                                    echo '<dl class = "def-list-1">';
                                                    echo '<dt>';
                                                    echo '<a href="supprimer_admin.php?id='.$admin['id'].'"><input type="button" value="Supprimer"></a>';
                                                    echo '</dt>';
                                                    echo '</dl>';
                                                    echo '<dl class = "def-list-1">';
                                                    echo '<dt>';
                                        ...
                                        <article class="indent-bot">
                                            <div class="wrapper hr-border-1">
                                                ...
                                                foreach ($liste_reserve as $reserve) {
                                                    ...
                                                    echo '<dl class = "def-list-1">';
                                                    echo '<dt>';
                                                    echo '<a href="supprimer_reserve.php?id='.$reserve['id'].'"><input type="button" value="Supprimer"></a>';
                                                    echo '</dt>';
                                                    echo '</dl>';
                                                    echo '<dl class = "def-list-1">';
                                                    echo '<dt>';
