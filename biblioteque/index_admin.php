                                        ...
                                        <article class="indent-bot">
                                            ...
                                            <div class="wrapper hr-border-1">
                                                ...
                                                foreach ($liste_livre as $livre) {
                                                    ...
                                                    echo '<dl class = "def-list-1">';
                                                    echo '<dt>';
                                                    echo '<a href="modifier_livre.php?id='.$livre['id'].'"><input type="button" value="Modifier"></a>';
                                                    echo '</dt>';
                                                    echo '</dl>';
                                                    echo '<dl class = "def-list-1">';
                                                    echo '<dt>';
                                                    echo '<a href="supprimer_livre.php?id='.$livre['id'].'"><input type="button" value="Supprimer"></a>';
                                                    echo '</dt>';
                                                    echo '</dl>';
                                                    echo '<dl class = "def-list-1">';
                                                    echo '<dt>';
                                        ...
                                        <article class="indent-bot">
                                            <div class="wrapper hr-border-1">
                                                <div class="grid_4 alpha">
                                                    <form method="post" action="ajout_livre_action.php">
                                                        <h2>Ajouter Livre</h2>
                                                        <dl class="def-list-1">
                                                            <dt>
                                                            Nom Livre:
                                                ...
                                                <div class="grid_4 alpha">
                                                    <form method="post" action="ajout_admin_action.php">
                                                        <h2>Ajouter Admin</h2>
                                                        <dl class="def-list-1">
                                                            <dt>
                                                            Login:
