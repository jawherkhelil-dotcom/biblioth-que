...
<html lang="en">
    <head>
        <title>Liste de votre reservation</title>
        <meta charset="utf-8">
        ...
        <div class="main-bg">
            ...
            <header>
                <div class="inner">
                    ...
                    <nav>
                        <ul class="sf-menu">
                            <li><a href="index_util.php?ii=<?php echo $id;?>">home</a></li>
                            <li class="current"><a href="liste_reserve.php">Liste de votre reservation</a></li>
                                ...
                                <div class="grid_16 suffix_1 prefix_1 alpha">
                                    <center>
                                        <article class="indent-bot">
                                            <h2>*Liste de votre reservation*</h2>
                                            <div class="wrapper hr-border-1">
                                                ...
                                                foreach ($liste_reserve as $reserve) {
                                                    ...
                                                    echo '<dl class = "def-list-1">';
                                                    echo '<dt>';
                                                    echo '<a href="supprimer_reserve.php?id='.$reserve['id'].'& ii='.$id.'"><input type="button" value="Supprimer"></a>';
                                                    echo '</dt>';
                                                    echo '</dl>';
                                                    echo '<dl class = "def-list-1">';
                                                    echo '<dt>';
